  ...
  return (
    ...
    >
      <View style={styles.container}>
        ...
        <View>
          <Text style={styles.title}>Prisoner HomePage</Text>
        </View>
        <View style={styles.cardContainer}>
          ...
          >
            <Image
              source={
                isCard1Pressed
                  ? require("../../assets/legalaid.png")
                  : require("../../assets/legalaid-golden.png")
              }
            ...
            <Text
              style={
                isCard1Pressed
                  ? [styles.cardTitle, styles.cardtitlepress]
                  : styles.cardTitle
              }
            >
              Legal Aid
          ...
          >
            <Image
              source={
                isCard2Pressed
                  ? require("../../assets/rehab.png")
                  : require("../../assets/rehab-golden.png")
              }
              style={styles.cardImage}
            />
            <Text
            ...
            <Image
              source={
                isCard3Pressed
                  ...
                  : require("../../assets/status-golden.png")
              }
              style={styles.cardImage}
            />
            <Text
            ...
            <Image
              source={
                isCard4Pressed
                  ...
                  : require("../../assets/chatbot-golden.png")
              }
              style={styles.cardImage}
            />
            <Text
