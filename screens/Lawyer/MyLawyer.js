     ...
     <>
        <ScrollView className="h-[100%] bg-[#EAECF9]" showsVerticalScrollIndicator={false}>
            ...
            <View className='p-2'>
                ...
                <View className='bg-white mt-2 flex-row items-center px-1 rounded-full py-1 justify-center' style={{elevation:5,shadowOffset:{width:6,height:6}}}><AcademicCapIcon size={20} color="#ff7751" /><Text className='text-sm ml-1 text-gray-500 font-medium'>8+ Years of Experience</Text><Text className='font-bold items-center justify-center mx-1'>|</Text><MapPinIcon size={18} color="#ff7754" /><Text className='text-sm ml-1 text-gray-500 font-medium'>Mumbai,MH</Text></View>
                <View className='bg-white mt-4 p-2 rounded-xl px-3' style={{elevation:5,shadowOffset:{width:6,height:6},shadowRadius:50}}><Text className='text-xl font-bold text-orange-400'>ABOUT</Text><Text className='text-sm text-gray-500 font-medium'>Darshit Shah is the new King of Law.
            ...
            <View className=' p-2' style={{elevation:5,shadowOffset:{width:6,height:6}}}>
                <View className='bg-white mt-1 p-2 rounded-xl px-3' style={{elevation:5,shadowOffset:{width:6,height:6}}} >
