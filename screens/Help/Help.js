  ...
  return (
    <View className=''>
         ...
         <View className='bg-white h-fit mx-3 rounded-2xl my-[-50px] p-4 justify-around mb-5' style={{elevation:10}}>
                <TouchableOpacity><View className='flex-row items-center p-2 justify-between my-2'><View className='flex-row items-center'><View className='bg-[#f6f6f6] p-1 rounded-full'><UserIcon color="orange" size={35}/></View><Text className='font-bold text-xl ml-4 text-gray-600'>FAQ's</Text></View><ChevronRightIcon color='gray' size={30}/></View></TouchableOpacity>
                <TouchableOpacity><View className='flex-row items-center p-2 justify-between my-2'><View className='flex-row items-center'><View className='bg-[#f6f6f6] p-1 rounded-full'><LockClosedIcon color="orange" size={35}/></View><Text className='font-bold text-xl ml-4 text-gray-600'>Chat</Text></View><ChevronRightIcon color='gray' size={30}/></View></TouchableOpacity>
                <TouchableOpacity><View className='flex-row items-center p-2 justify-between my-2'><View className='flex-row items-center'><View className='bg-[#f6f6f6] p-1 rounded-full'><EyeIcon color="orange" size={35}/></View><Text className='font-bold text-xl ml-4 text-gray-600'>Call us</Text></View><ChevronRightIcon color='gray' size={30}/></View></TouchableOpacity>
